...
@RelationshipEntity(type = "MODERATES")
public class Moderates {
    ...
    public boolean equals(Object o) {
        ...
        Moderates moderates = (Moderates) o;
        ...
        if (!anon.equals(moderates.anon)) return false;
        return chat.equals(moderates.chat);
